...
CREATE TABLE public."GenderWords" (
	...
	CONSTRAINT lexicon_gender_id_fkey FOREIGN KEY ("lexicon_id") REFERENCES public."Lexicon"("id")
);
...
CREATE TABLE public."Conjugation" (
	...
	PRIMARY KEY ("lexicon_id"),
	CONSTRAINT lexicon_conjug_id_fkey FOREIGN KEY ("lexicon_id") REFERENCES public."Lexicon"("id")
);
